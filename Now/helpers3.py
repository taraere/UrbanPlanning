...
# do i use the ortodox method or unortodox method of calulation??
ORTHODOX = True
...
class Rectangle(object):
    ...
    def getShortestDistanceOld(self, otherBoundaries):
        ...
        # instantiate with a large number, so the first one will always become shorter
        shortest = 300
    ...
    def getShortestDistance(self, allCorners):
        ...
        for setCorners in allCorners:
            ...
            for selfC in selfCorners:
                ...
                # per other corner coordinate in set
...
class Map(object):
    ...
    def load():
        ...
        pass
    def save(self, name):
        file_name = "Saves/" + str(self.calculateValue()) + "_" + name + ".csv"
        with open(file_name, "w"):
            ...
            for water in self.waterBody:
                row = [[water.boundary.x1, water.boundary.y1], [water.boundary.x2, water.boundary.y2], "water"]
                locationList.append(row)
