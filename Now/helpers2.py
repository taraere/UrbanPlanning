...
class Map(object):
    ...
    def addWater(self):
        ...
        while (testSize * bodiesLeft >= waterLeft and waterLeft != 0):  # macro while loop
            ...
            while(tries < MAX_TRIES):    # micro while loop
                # if the water-body isn't touching any houses or other bodies, and is within the map
    ...
    def save(self):
        ...
        file_name = "Saves/" + "Tara" + str(self.calculateValue()) + ".csv"
