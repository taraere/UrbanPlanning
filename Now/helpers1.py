...
class Map(object):
    ...
    def calculateValue(self):
        ...
        for house in self.house:
            ...
            allCorners.append(bound_coords)
    ...
    def save(self):
        ...
        with open(file_name, "w"):
            ...
            for water in self.water:
                row = [[water.boundary[0], water.boundary[1]], [water.boundary[2], water.boundary[3]], "water"]
                locationList.append(row)
            writer = pandas.DataFrame(locationList, columns=["x-co-ordinate", "y-co-ordinate", "house-type"])
            writer.to_csv(file_name, index=False)
            print("location list" + str(locationList))
    ...
    def saveJSON(self, nameOfFile):
        ...
        # construct a dictionary of map data
        data = {}
